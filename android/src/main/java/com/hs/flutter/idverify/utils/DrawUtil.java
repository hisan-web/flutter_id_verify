package com.hs.flutter.idverify.utils;
...
public class DrawUtil {
    ...
    public static void drawFaceRect(Canvas canvas, Rect rect, int color, int faceRectThickness) {
        ...
        mPath.quadTo(rect.left, rect.top, rect.left + rect.width() / 6, rect.top);

        // 右上
        mPath.moveTo(rect.right - rect.width() / 6, rect.top);
        mPath.quadTo(rect.right, rect.top, rect.right, rect.top + rect.height() / 6);
        // 右下
        mPath.moveTo(rect.right, rect.bottom - rect.height() / 6);
        mPath.quadTo(rect.right, rect.bottom, rect.right - rect.width() / 6, rect.bottom);

        // 左下
        mPath.moveTo(rect.left + rect.width() / 6, rect.bottom);
        mPath.quadTo(rect.left, rect.bottom, rect.left, rect.bottom - rect.height() / 6);
